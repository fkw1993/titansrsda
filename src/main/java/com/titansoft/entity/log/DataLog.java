...
public class DataLog {
    ...
    public DataLog(){}
    public DataLog(String id, String username, String realname, String userorgan, String userorganid, String ipaddress,
                   String dotime, String dodesc, String functionname, String isnormal, String position) {
        super();
        this.id = id;
